...
public class mainViewer extends javax.swing.JFrame {
        ...
        menu.addEventMenu(new EventMenu(){
            ...
            public void selectedMenu(int index){
                if (index == 0){
                    ...
                    mainBody.displayForm(new Subject_Form(), "Subject");
                }
                else if (index == 4){
                    mainBody.displayForm(new Teacher_Form(),"Teacher");
                }
                else if (index == 5){
    ...
    private void initComponents() {
        ...
        menu = new csms.database.menu.MenuStudent();
    ...
    private csms.database.menu.MenuStudent menu;
