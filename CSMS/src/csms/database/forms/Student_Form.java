...
import csms.database.component.StudentPanel;
...
public class Student_Form extends Form {
    ...
    private void initDark(){
        if(ThemeColorChange.getInstance().getMode() == ThemeColorChange.Mode.DARK){
            ...
            txtSgs.setForeground(new Color(230,230,230));
            ...
            sgstxt.setForeground(new Color(230,230,230));
            ...
            txtSgs.setForeground(new Color(80,80,80));
            ...
            sgstxt.setForeground(new Color(80,80,80));
    ...
    private void initUpdate(){
        ...
        try {
            if (sort.getSelectedIndex() == -1) {
                ...
                ResultSet rs = stmt.executeQuery("SELECT * FROM student ORDER BY last_name");
                while (rs.next()) {
                    String name = rs.getString("last_name") + ", " + rs.getString("first_name"); // rs.getString("first_name") + " " + rs.getString("last_name")
                    String bio = rs.getString("student_desc");
                    String email = rs.getString("email");
                    String contact = rs.getString("contact_no");
                    String facebook = rs.getString("facebook");
                    String address = rs.getString("address");
                    int sgsid = rs.getInt("sgs_id");
                    String sgs = convertSgs(sgsid);
                    ...
                    student.setAvatar(format);
                    student.setSgs(sgs);
                    student.setBio(bio);
                    student.setContact(contact);
                    student.setFacebook(facebook);
                    student.initEvent(this);
                    choosepanel.add(student);
                }
            } else {
                Statement stmt = dbconn.createStatement();
                ResultSet rs = stmt.executeQuery("SELECT * FROM student where sgs_id=" + sort.getSelectedIndex() + " ORDER BY last_name");
                while (rs.next()) {
    ...
    private void choice(){
        ...
        try {
            ...
            while (rs.next()){
                ...
                sort.addItem(sgsChoice);
            }
        } catch (SQLException ex) {
            Logger.getLogger(Student_Form.class.getName()).log(Level.SEVERE, null, ex);
        }
        sort.setSelectedIndex(-1);
        sort.setForeground(Color.decode("#7A8C8D"));
    }
    
    private String convertSgs(int sgsid) throws SQLException{
        Statement stt = dbconn.createStatement();
        ResultSet rss = stt.executeQuery("SELECT * FROM sgs WHERE sgs_id=" + sgsid);
        rss.next();
        String sgs = rss.getString("strand") + " " + String.valueOf(rss.getInt("grade")) + "-" + rss.getString("section");
        rss.close();
        stt.close();
        return sgs;
    }
    ...
    private void initComponents() {
        ...
        sgstxt.setText("Strand/Grade/Section:");
            ...
            .addGroup(bgpanelLayout.createSequentialGroup()
                ...
                .addGroup(bgpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(bgpanelLayout.createSequentialGroup()
                        ...
                        .addComponent(txtSgs, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(bgpanelLayout.createSequentialGroup()
                        .addComponent(numtxt)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        bottom.setText("*You can manage students in the 'Admin' tab.");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(sort, javax.swing.GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE)
    ...
    private javax.swing.JLabel sgstxt;
    private csms.login.swing.Choice sort;
    ...
    public javax.swing.JLabel txtSgs;
