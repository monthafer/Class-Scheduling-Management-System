...
public class WinButton extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMi = new csms.database.component.Button();
        cmdRe = new csms.database.component.Button();
        cmdClose = new csms.database.component.Button();

        cmdMi.setBackground(new java.awt.Color(244, 244, 0));

        cmdRe.setBackground(new java.awt.Color(0, 204, 0));
    ...
    private csms.database.component.Button cmdMi;
    private csms.database.component.Button cmdRe;
