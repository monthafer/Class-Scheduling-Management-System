...
import csms.database.swing.SwitchButton;
...
public class ImageBackgroundOption extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttomImage1 = new csms.database.swing.ButtomImage();
        buttomImage2 = new csms.database.swing.ButtomImage();
        buttomImage3 = new csms.database.swing.ButtomImage();
        buttomImage4 = new csms.database.swing.ButtomImage();
        buttomImage5 = new csms.database.swing.ButtomImage();

        setOpaque(false);

        jPanel1.setOpaque(false);

        lbBack.setBackground(new java.awt.Color(80, 80, 80));
        lbBack.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        lbBack.setForeground(new java.awt.Color(80, 80, 80));
        lbBack.setText("Background Image");

        jLabel1.setForeground(new java.awt.Color(128, 128, 128));
        jLabel1.setText("Use simple image as the system's background.");
        ...
        buttomImage1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/csms/database/background/bg_1_small.jpg"))); // NOI18N
        buttomImage1.setSelected(true);

        buttomImage2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/csms/database/background/bg_2_small.jpg"))); // NOI18N

        buttomImage3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/csms/database/background/bg_3_small.jpg"))); // NOI18N

        buttomImage4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/csms/database/background/bg_4_small.jpg"))); // NOI18N

        buttomImage5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/csms/database/background/bg_5_small.jpg"))); // NOI18N
    ...
    private csms.database.swing.ButtomImage buttomImage1;
    private csms.database.swing.ButtomImage buttomImage2;
    private csms.database.swing.ButtomImage buttomImage3;
    private csms.database.swing.ButtomImage buttomImage4;
    private csms.database.swing.ButtomImage buttomImage5;
